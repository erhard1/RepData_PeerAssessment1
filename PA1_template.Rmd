...
```{r 'calculate_overall_fraction_of_and_total_number_of_NAs', echo=FALSE}
...
```{r 'calculate_fraction_of_df_with_NAs'}
...
```{r 'histogram_of_total_steps_per_day_w/o_NAs'}
...
```{r 'mean_and_median_steps_per_day_w/o_NAs'}
...
```{r 'calculate_total_and_avg_steps_per_interval_w/o_NAs'}
...
```{r 'time_series_plot_of_avg_steps_per_interval_w/o_NAs'}
...
```{r 'find_the_interval_with_the_max_avg_step_count_w/o_NAs'}
...
```{r 'create_new_dataframe_for_imputed_steps'}
...
```{r 'create_imputed_step_counts_for_each_interval'}
...
```{r 'calculate_total_daily_step_count_using_imputed_step_counts'}
...
```{r 'histogram_of_daily_step_total_using_imputed_step_data'}
...
```{r calculate_mean_and_median_daily_step_count_using_imputed_step_counts}
...
```{r 'creating_and_populating_the_type_of_day_variable_to_have_levels_of_"Weekday"_and_"Weekend"'}
...
```{r 'calculating_the_activity_patterns_for_weekdays_and_weekends_separately_and_then_combining_them'}
...
```{r 'two_panel_time_series_plot_of_avg_interval_step_data_for_Weekdays_and_Weekends'}
